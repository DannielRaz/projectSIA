...
<body>
    <div class="registration-container">
        <h2>Create Account Guidance</h2>
        <form action="registrationguidance.php" method="post">
            ...
            <input type="hidden" id="role" name="role" value="guidance">

            <input type="submit" value="Create Account">
        </form>
        <button onclick="goToLoginPage()">Guidance Dashboard</button>
    </div>
